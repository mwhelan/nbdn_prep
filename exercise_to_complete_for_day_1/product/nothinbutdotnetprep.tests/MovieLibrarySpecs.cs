...
namespace nothinbutdotnetprep.tests
{
    public class MovieLibrarySpecs
    {
        ...
        public class when_searching_for_movies : searching_and_sorting_concerns_for_movie_library
        {
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_movies_published_by_pixar());
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_movies_not_published_by_pixar());
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_movies_published_after(2004));
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_movies_published_between_years(1982, 2003));
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_kid_movies());
            ...
            {
                var results = sut.all_movies_that_are_satisfied_by(MovieLibrary.all_action_movies());
